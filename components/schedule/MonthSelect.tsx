...
export default function MonthSelect() {
  ...
  return (
    <div className="flex items-middle text-gray-600">
      <button className="font-bold px-2" onClick={() => dispatch({ type: Action.CHANGE_PREVIOUS, value: "" })}>
        <BaseIcon>
      ...
      />
      <button className="font-bold px-2" onClick={() => dispatch({ type: Action.CHANGE_NEXT, value: "" })}>
        <BaseIcon>
